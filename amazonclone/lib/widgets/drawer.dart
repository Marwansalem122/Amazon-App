...
import 'package:amazonclone/history/history_screen.dart';
import 'package:amazonclone/not_yet_recieve_parcels/not_yet_recieved_shifted_parcels_screen.dart';
            ...
            child: Column(
              children: [
                ...
                drawElement(Icons.picture_in_picture_alt_rounded,
                    "Not Yet Receive Parcels", () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const NotYetRecievedShiftedParcelsScreen()));
                }),
